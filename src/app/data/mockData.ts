...
export const MOCK_VEHICLES: VehicleEntry[] = [
  ...
  },
  {
    ...
    exitGraceUntil: new Date(Date.now() - 27 * 60 * 1000).toISOString(),
  ...
  },
  {
    ...
    exitGraceUntil: new Date(Date.now() - 72 * 60 * 1000).toISOString(),
    exitTime: new Date(Date.now() - 75 * 60 * 1000).toISOString(),
    duration: 120,
    amount: 4800,
    isPaid: true,
    paymentMethod: 'card',
